...
export class PlayerInGame {
  ...
  /**
   * Reference vers User (nullable pour les IA)
   */
   ...
   * Pour les users: leur username
   * Pour les IA: genere (ex: "AI_Player_1")
   */
  @Column()
  username: string;
   ...
   * Reset a 0 a chaque nouveau tour (flop, turn, river)
   */
   ...
   * Important pour determiner l'ordre de jeu
   */
  @Column()
  position: number;
